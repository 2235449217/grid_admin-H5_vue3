...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			// 身份证号
			this.infomation.idInfo = Result.id_card_num;
			// 手机号
			...
			// 出发地
			this.infomation.origin_place = Result.origin_place;
			// 目的地
			this.infomation.destination_place = Result.destination_place;
			// 返乡时间
			this.infomation.departure_time = Result.departure_time;
